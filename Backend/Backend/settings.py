...
SECRET_KEY = 'django-insecure-jrpe+)y-tq1%(dh#0$kj(zvb2)(pagx&$$&vl%0i4$e+$sisj%'
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'static'  # optional for collectstatic in dev
...
CORS_ALLOWED_ORIGINS = [
    "http://192.168.1.100:8081",  # Your Expo dev server
    "http://localhost:8081",
]
...
# Django must listen on 0.0.0.0 to accept network requests
